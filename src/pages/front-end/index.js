    ...
    <div class="min-h-screen">
      <div id="frond_end">
        <Container>
          ...
          <h2 class="pt-8 md:pt-10 lg:pt-12 text-2xl font-bold text-gray-700 dark:text-white md:text-4xl">
            Mục tiêu đào tạo
          </h2>
          <div class="p-6 mt-6 md:mt-8 lg:mt-10   rounded-md border border-gray-100 text-gray-600 dark:border-gray-700  ">
