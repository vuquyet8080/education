...
export const Stats = ({ showLinkFigma = true }) => {
  return (
    <div id="solution">
      <Container>
        <div class=" space-y-6 justify-between text-gray-600 md:flex flex-row-reverse md:gap-6 md:space-y-0 lg:gap-12 ">
          <div class="md:w-1/2 ">
          ...
          <div class="md:w-1/2 h-full">
            <p class=" text-xl font-bold text-gray-600 dark:text-white md:text-2xl ">
              HRM project
            </p>
            ...
            {showLinkFigma && (
              <div class="divide-y space-y-4 divide-gray-100 dark:divide-gray-800">
                <Link href={"#"}>
                  <div class="mt-8 flex gap-4 md:items-center hover:cursor-pointer ">
                    <div class="hover:scale-105 flex justify-center items-center w-12 h-12  gap-4 rounded-full bg-indigo-100 dark:bg-indigo-900/20">
                      <FigmaIcon />
                    </div>
                    <div class="w-5/6 ">
